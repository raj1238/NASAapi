    ...
    <div className="App">
        ...
        <div className="container list-of-asteroids">
          <div className="row justify-content-center">
              ...
              <h3 className = 'heading'>Welcome to explore Asteroids</h3>
          </div>
          <div className="row mt-3 mb-5">
            <button className="offset-4 btn btn-success" onClick={fetchData}>
        ...
        <div className="container list-using-range">
              <div className="row mt-5 justify-content-center offset-1">
                  <h2 className = 'note mb-5'>Note - End Date should be after Start Date</h2>
                  <form onSubmit={fetchDataRange}>
                    <div className="row">
                      <div className="col-md-5">
                        <div className="form-group">        
                              <label className = 'range' for="start"> Start date:</label>
                              <hr/>
                      ...
                      <div className="col-md-5">
                        <div className="form-group">        
                              <label className = 'range' for="end"> End date:</label>
                              <hr/>
        ...
        <div className="container list-using-id">
              <div className="row">
                  <div className="col-md-5">
                    <form onSubmit = {fetchDataID}>
                        <div className="form-group">        
                            <label className = 'listID' for="ID"> Search by ID: </label>
                            <hr/>
